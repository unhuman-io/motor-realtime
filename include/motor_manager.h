...
class MotorManager {
 public:
    ...
    std::vector<std::shared_ptr<Motor>> get_motors_by_ip_can(std::vector<std::string> ips, bool connect = true, bool print_unconnected = true, bool allow_simulated = false, std::vector<std::string> ip_aliases = {});
