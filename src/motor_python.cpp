...
PYBIND11_MODULE(motor, m)
{
    ...
    py::class_<MotorManager>(m, "MotorManager")
        ...
        .def("get_motors_uart_by_devpath", &MotorManager::get_motors_uart_by_devpath, py::arg("devpaths"), py::arg("baud_rate") = 4000000, py::arg("connect") = true, py::arg("allow_simulated") = false)
