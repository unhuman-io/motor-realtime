...
int main(int argc, char** argv) {
    ...
    auto eth_l2_option = app.add_option("-e,--eth-l2", macs, "Connect to motor eth l2 MAC(S). If left empty, connect to all macs --json-ip-file")->type_name("MAC")->expected(0,-1)->default_str("{}");
