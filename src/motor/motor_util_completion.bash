    ...
    case $subcommand in
        set) words="--host_time --mode --current --position --velocity --torque --reserved  position_tuning current_tuning stepper_tuning voltage stepper_velocity read -h --help";
            case $last in
                ...
                --mode) words="open damped current position velocity torque impedance current_tuning position_tuning voltage phase_lock stepper_tuning hardware_brake sleep crash reset" ;;
            esac ;;
