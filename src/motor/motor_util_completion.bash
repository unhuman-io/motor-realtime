...
_motor_util_completion()
{
    ...
    COMREPLY=()
    local words
    local base_words="-l --list --list-names-only --list-path-only -n --names set read -v --version -u --user-space -h --help";
    case $subcommand in
        ...
        read) words="--poll --aread --frequency --statistics --text set -h --help";
            case $last in
                --frequency) return 0 ;;
            esac ;;
